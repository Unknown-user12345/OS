...
void calculate_metrics(Process p[], int n, double total_actual_time, int context_switches) {
    ...
    printf("\n");
    printf("========================================================================================\n");
    printf("                       PERFORMANCE METRICS (Linux - FCFS)                              \n");
...
int main() {
    Process processes[] = {
        {1, "Video Capture - Cam1", 0, 5, 0, 0, 0, 0, 0},
        {2, "Video Capture - Cam2", 0, 5, 0, 0, 0, 0, 0},
        {3, "Motion Detection - Zone1", 1, 4, 0, 0, 0, 0, 0},
        {4, "Motion Detection - Zone2", 1, 4, 0, 0, 0, 0, 0},
        {5, "Live Streaming - Station1", 2, 6, 0, 0, 0, 0, 0},
        {6, "Live Streaming - Station2", 2, 6, 0, 0, 0, 0, 0},
        {7, "Alert Generation - System", 3, 3, 0, 0, 0, 0, 0},
        {8, "Face Recognition - Cam1", 4, 7, 0, 0, 0, 0, 0},
        {9, "Face Recognition - Cam2", 4, 7, 0, 0, 0, 0, 0},
        {10, "Video Log Storage", 5, 5, 0, 0, 0, 0, 0},
        {11, "Intrusion Detection", 6, 4, 0, 0, 0, 0, 0},
        {12, "Analytics Processing", 7, 8, 0, 0, 0, 0, 0},
        {13, "Threat Assessment", 8, 6, 0, 0, 0, 0, 0},
        {14, "Report Generation", 9, 5, 0, 0, 0, 0, 0},
        {15, "Database Sync", 10, 4, 0, 0, 0, 0, 0}
    };
    ...
    // Calculate theoretical times (SAME for all OS)
    ...
    for (int i = 0; i < n; i++) {
        ...
        if (processes[i].arrival_time > elapsed) {
            double wait_time = processes[i].arrival_time - elapsed;
            sleep((int)wait_time);
        }
        ...
        context_switches++; // Each process execution is a context switch
